...
Each piece in this corpus is represented by five files with identical names, each in its own folder. For example, the Mazurka G major (Brown Index 16, no. 1) has the following files:
