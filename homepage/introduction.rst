...
* `Frédéric Chopin – Mazurkas <https://github.com/DCMLab/chopin_mazurkas/archive/refs/heads/main.zip>`__


Data Formats
============

Each piece in this corpus is represented by four files with identical names, each in its own folder. For example, the Mazurka G major (Brown Index 16, no. 1) has the following files:
...
-  ``harmonies/BI16-1.tsv``: A list of the included harmony labels (including cadences and phrases) with their positions in the score.
...
For questions, remarks etc., please `create an issue <https://github.com/DCMLab/chopin_mazurkas/issues>`__ and feel free to fork and submit pull requests.
